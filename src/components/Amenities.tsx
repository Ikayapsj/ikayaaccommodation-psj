...
const Amenities = () => {
  return <section id="amenities" className="section-padding bg-coastal-brown">
      <div className="container mx-auto">
        <h2 className="section-title text-white">Guest <span className="text-white">Amenities</span></h2>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {amenitiesData.map((amenity, index) => <div key={index} className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-all">
              <div className="bg-coastal-cream rounded-full h-14 w-14 flex items-center justify-center mb-4">
                <amenity.icon style={{
              color: '#5f7f61'
            }} size={24} />
              </div>
              <h3 className="text-xl font-subheading font-semibold mb-2" style={{
            color: '#5f7f61'
          }}>{amenity.name}</h3>
        ...
        <div className="mt-16 bg-coastal-green rounded-lg overflow-hidden shadow-lg">
          <div className="grid md:grid-cols-2">
            <div className="p-8 md:p-12 flex flex-col justify-center">
              ...
              color: 'white'
            }} className="bg-white text-coastal-green hover:bg-white/90 px-6 py-3 rounded-md inline-block transition-colors w-max font-medium text-coastal-green font-bold ">
                Book Your Stay
              </a>
            </div>
