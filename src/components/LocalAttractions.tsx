  ...
  const attractions = [
    {
      ...
      description: "Silaka Nature Reserve covers a total of 400ha, featuring grassland and magnificent indigenous coastal forests along a dramatic piece of coastline. Trails lead through the evergreen forest and provide the opportunity to view elusive birds such as Knysna Loerie, Cinnamon Dove and Grey Cuckooshrike. The Gxwaleni River flows through the forest and you should look out for Halfcollared Kingfisher and Longtailed Wagtail at fast flowing stretches. Blue Duiker and Bushbuck are indigenous to the forest but are secretive and seldom seen. Thick-billed Weaver and Yellow-throated Longclaw breed in the marsh, from where Cape Clawless Otters may venture onto the beach. Interesting rock pools occur on the shore surrounding the island, which may be reached at low tide. At the estuary opposite Bird Island, an attractive pebble beach is surrounded by driftwood and aloes, which grow almost to the sea. Large stands of banana-like Strelitzia nicolai blanket some of the sea-facing slopes, where Flame Lilies bloom."
    },
    {
      name: "Magwa Falls",
